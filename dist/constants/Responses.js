...
const responses = {
    ...
    BOOK_NOT_CREATED: "Unable to save book",
    ...
    INACTIVE_USER: "User is inactive. If you have signed up recently please check your email for verification. Else, please contact the site admin.",
    SUCCESS: "success",
    ...
    RESEND_VERIFICATION_LIMIT_ERROR: "Could not send resent link, Limit exceeded!. Try again after 24 hours.",
    ...
    STRIPE_PAYMENT_METHOD_NOT_CREATED: "Could not create a payment method on Stripe.",
    STRIPE_PAYMENT_METHOD_NOT_ATTACHED: "Could not attach a payment method to customer on Stripe.",
    STRIPE_CUSTOMER_PAYMENT_METHODS_NOT_FOUND: "No payment methods found on Stripe.",
    STRIPE_PAYMENT_INTENT_NOT_CREATED: "Could not create a payment intent on Stripe.",
    STRIPE_PAYMENT_INTENT_NOT_CONFIRMED: "Payment intent could not be confirmed on Stripe.",
